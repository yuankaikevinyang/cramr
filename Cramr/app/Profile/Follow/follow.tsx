...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontFamily: 'Arial' },
  ...
  searchInput: { flex: 1, fontSize: 16, fontFamily: 'Arial' },
  ...
  avatarText: { fontSize: 18, fontFamily: 'Arial', color: '#333' },
  userInfo: { flex: 1 },
  userName: { fontSize: 16, fontFamily: 'Arial', marginBottom: 2 },
  userUsername: { fontSize: 14, fontFamily: 'Arial' },
  removeButton: {borderRadius: 10 },
  emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 40 },
  emptyText: { fontSize: 16, fontFamily: 'Arial', textAlign: 'center' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' },
  modalContent: { borderRadius: 12, padding: 20, margin: 20, minWidth: 300 },
  modalTitle: { fontSize: 16, fontFamily: 'Arial', textAlign: 'center', marginBottom: 20 },
  modalButtons: { flexDirection: 'row', gap: 10 },
  modalCancelButton: { flex: 1, padding: 12, borderRadius: 8, alignItems: 'center' },
  modalCancelText: { fontSize: 16, fontFamily: 'Arial' },
  modalConfirmButton: { flex: 1, padding: 12, borderRadius: 8, backgroundColor: '#E36062', alignItems: 'center' },
  modalConfirmText: { fontSize: 16, fontFamily: 'Arial' },
});
