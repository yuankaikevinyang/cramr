...
const styles = StyleSheet.create({
  ...
  subheading: { marginBottom: 10, fontSize: 16, fontFamily: 'Arial' },
  input: {
    borderWidth: 1,
  ...
  errorText: { color: 'red', marginBottom: 16, fontFamily: 'Arial' },
  saveButton: {
  ...
  saveButtonText: { fontSize: 16, textAlign: 'center', fontFamily: 'Arial' },
  divider: { height: 1, backgroundColor: '#ccc', marginVertical: 16 },
  deleteButton: { backgroundColor: '#E36062', padding: 10, borderRadius: 12 },
  deleteButtonText: { fontSize: 16, textAlign: 'center', fontFamily: 'Arial' },
  modalBackground: {
    flex: 1,
  ...
  cancelText: { fontSize: 16, color: '#000', fontFamily: 'Arial' },
  confirmText: { fontSize: 16, color: '#000', fontFamily: 'Arial' },
